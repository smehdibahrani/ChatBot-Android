...
class CreateChatRoomViewModel(dataManager: DataManager, schedulerProvider: SchedulerProvider) :
    BaseViewModel<CreateChatRoomCallback>(dataManager, schedulerProvider) {
            ...
            override fun onResponse(
                ...
                when {
                    response.isSuccessful -> {
                        ...
                        if (chatRoom != null) {
                            MySocket.instance.sendRequestJoin(chatRoom.token)
